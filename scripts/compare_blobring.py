"""Baseline comparison for Blob -> Ring. See compare_ewi.py for the full
explanation of the four methods and the equal-footing rule (A and C never
see fresh draws from the true p0 -- only the burn-in segment of this
series, or a bootstrap of it)."""
