"""Monte-Carlo operating-characteristics study for Four clusters -> one
cluster. See mc_ewi.py / mc_lib.py for the shared harness and equal-footing
rule; see compare_quadblob.py for the single-trajectory version this
extends to 1000 independent trials with tau ~ Uniform(W_MMD, L)."""
